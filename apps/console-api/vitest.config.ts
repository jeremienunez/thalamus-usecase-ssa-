...
const aliases = {
  ...
  "@interview/shared/config": resolve(root, "packages/shared/src/config/index.ts"),
  "@interview/shared": resolve(root, "packages/shared/src/index.ts"),
  "@interview/thalamus/explorer/curator": resolve(root, "packages/thalamus/src/explorer/curator.ts"),
  "@interview/thalamus/explorer/nano-caller": resolve(root, "packages/thalamus/src/explorer/nano-caller.ts"),
  "@interview/thalamus/explorer/nano-swarm": resolve(root, "packages/thalamus/src/explorer/nano-swarm.ts"),

...
function temporalPattern(
  ...
  return {
    ...
    patternRate: 0.83,
    lift: 2.4,
    bestComponentSignature: "agent.retry_started|agent|none|none",
    bestComponentRate: 0.4,
    sequenceLiftOverBestComponent: 0.43,
    leadTimeMsAvg: 120_000,
    leadTimeMsP50: 100_000,
    leadTimeMsP95: 200_000,

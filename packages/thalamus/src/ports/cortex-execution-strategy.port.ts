/**
 * Port: CortexExecutionStrategy — Strategy Pattern for cortex execution.
 *
 ...
 */
import type { CortexSkill } from "../cortices/registry";
import type { CortexInput, CortexOutput } from "../cortices/types";
